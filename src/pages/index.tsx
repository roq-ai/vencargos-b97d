...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`VEncargos`}</title>

        <meta
          name="description"
          content="Experience VEncargos - Your One-Stop Destination for VTuber Services. Seamless Transactions with Stripe, Paypal and Country-Based Payment Options. Now Available on Mobile for Your Convenience."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience VEncargos - Your One-Stop Destination for VTuber Services. Seamless Transactions with Stripe, Paypal and Country-Based Payment Options. Now Available on Mobile for Your Convenience.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Agencies" type="agencies" />
